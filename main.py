...
- Qi classified celestial bodies into stars, galaxies, and quasars using Decision Tree, Random Forest, and SVM models [3]. SMOTE, normalization, and data splitting were used for preprocessing [3]. Random forest had the best copmuting performance and accuracy [3].
...
- Data Transformation: Encoding categorical data into numerical values, one-hot encoding because spectral types have roman numerals
    """)
st.write(""" 
**ML Models:**
...
Recall and precision work well together to ensure that a model is able to identify positive instances and are precise in doing so. 
         Accuracy is a helpful, standard metric, so a combination of these three metrics will help evaluate the performance of our models given our dataset.
