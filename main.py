...
- Qi classified celestial bodies into stars, galaxies, and quasars using Decision Tree, Random Forest, and SVM models [3]. Random forest had the best copmuting performance and accuracy [3].
